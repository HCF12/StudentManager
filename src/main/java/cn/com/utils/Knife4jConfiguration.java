...
public class Knife4jConfiguration implements WebMvcConfigurer {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Knife4j RESTful APIs")
			.description("\uD83E\uDD16 Spring Boot 2.x 实践案例（Quartz实战）")
			.termsOfServiceUrl("https://github.com/ElanYoung/spring-boot-learning-examples/")
